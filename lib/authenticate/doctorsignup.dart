...
import 'package:flutte_app/authenticate/doctorlogin.dart';
...
class Doctorlosignup extends StatefulWidget {
  @override
  _DoctorlosignupState createState() => _DoctorlosignupState();
}

class _DoctorlosignupState extends State<Doctorlosignup> {
                    ...
                    NiceButton(
                      ...
                      onPressed: () async {
                        if (_formkey.currentState.validate()) {
                          ...
                          dynamic result =
                              await _auth.registerDoctorWithEmailandPassword(
                          ...
                          if (result == null) {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => Hospitaldetais()));
                          }
                        }
                      },
                      text: 'Register',
